...
<head>
  ...
  <title>Order Lessed Products</title>
...
$(document).on('click','.activate',function(){
  ...
  var user_info = {
    url:'./assets/php/addproducts.php'
    ,type:'POST'
    ,data:{activate:1,prd_id:$(this).attr('id')}
    ,callback:load_users}
...
$(document).on('click','.order',function(){
    ...
    let qty = $("#qty_"+$(this).attr('id')).val();
    let sup = $(this).attr('sup_id');
    let prd_id = $(this).attr('id');
    console.log({order:1,prd_id:prd_id,qty:qty,sup:sup});
    var user_info = {
      url:'./assets/php/addproducts.php'
      ,type:'POST'
      ,data:{order:1,prd_id:prd_id,qty:qty,sup:sup}
      ,callback:load_users}
