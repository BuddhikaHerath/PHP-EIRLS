  ...
  <div id='modal_in'>
   ...
   <table id="canceled_order" class="table table-bordered table-striped">
      ...
      <div class="modal-footer">
        ...
        <button type="button" id='recervied' class="btn btn-primary">Make As Recervied</button>
      </div>
    </div>
  </div>
</div>
...
confirm
$("#recervied").click(function(){
    var user_info = {
    url:'./assets/php/ihandeljson.php'
    ,type:'POST'
    ,data:{recervied:order_id}
    ,callback:function(response){
      load_users();
      $('#exampleModal').modal('toggle');
       console.log(response);
